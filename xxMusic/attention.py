    ...
    def forward(self, input):
        """
            ...
            returns : output feature map 
                      attention
        """
        #num_heads = 10 and dictionary size = 20
        input1 = input.expand(10, -1, -1).permute(1, 0, 2)
        input2 = input1.expand(20, -1, -1, -1).permute(1, 2, 0, 3)
        input = input2
...
class Attention(nn.Module):
    ...
    def forward(self, input):
        #input = input.expand(3,-1,-1).permute(1,0,2)
